...
namespace wlf {
    ...
    namespace {
        ...
        constexpr AssertionLevel operator| (AssertionLevel lhs, AssertionLevel rhs) {
            return static_cast<AssertionLevel> (
                static_cast<ptrdiff_t>(lhs) | static_cast<ptrdiff_t>(rhs)
            );
        }

        inline constexpr AssertionLevel EnabledAssertions = AssertionLevel::None
